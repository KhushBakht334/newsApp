...
async componentDidMount(){
  let url=`https://newsapi.org/v2/top-headlines?county=${this.props.country}&category=${this.props.category}&apiKey=00d639c2e9cf4c8cb043d42cb9c32c30&page=1&pageSize=20`;
